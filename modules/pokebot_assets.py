...
class PokeBotAssets:
    ...
    def _load_pokemon_imgs(self, pkmn_type: str) -> defaultdict:
        ...
        try:
            ...
            print("An error has occurred loading pokemon images."
                  " See error.log.")
            logger.error(f"{PokeBotAssetsException.__name__}: {str(e)}")
    ...
    def get_random_pokeball_emoji(self) -> str:
        ...
        try:
            ...
            print("An error has occurred in getting random pokeball"
                  " emoji. See error.log.")
            logger.error(f"{PokeBotAssetsException.__name__}: {str(e)}")
